...
public class VoiceKeyTest {
    ...
    public void testVoiceKeyCreationAndState() throws Exception {
        ...
        Assert.assertFalse("Voice should not be locked when activated without lock", keyboard.isVoiceLocked());
        ...
        Assert.assertTrue("Voice should be active after activation with lock", keyboard.isVoiceActive());
